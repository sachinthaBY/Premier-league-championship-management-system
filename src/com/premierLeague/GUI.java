...
public class GUI extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        primaryStage.setTitle("Premier League Championship Management System");
        ...
        Collections.sort(sorted); //sorted by club list
    ...
    //creating table
            ...
            TextField txtNa = new TextField(); //creating text feild
            ...
            // for loop
            for (Match m : sorted1){
                tbv1.getItems().add(m); //adding items to the table view
            }
            lal1.setOnAction(new EventHandler<ActionEvent>() {
                @Override
                public void handle(ActionEvent event) {
                    tbv1.getItems().clear(); //clear existing table view
                    Match found = premierLeagueManager.getMatchByDate(txtNa.getText()); //get match date add to the txtNa text field
                    tbv1.getItems().add(found); //adding items to the table view

                }
            });


            pane.getChildren().addAll(tbv1,l1,lal1, txtNa); //adding buttons and labels to the pane
            tbv1.setMinWidth(525);
            txtNa.setLayoutX(250); //set text field location
