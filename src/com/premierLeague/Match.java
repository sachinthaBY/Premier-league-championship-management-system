...
public class Match implements Comparable<Match>, Serializable {
    ...
    private String name1; //name of the team 1
    private String name2; //name of the team 2

    private Date matchDate; //played match date
    ...
    public Match(FootballClub team1, String team1Score, FootballClub team2, String team2Score, Date matchDate) {
        ...
        this.name1 = team1.getNameOfTheClub(); //name of the club add to the team 1 and, it adds as name 1
