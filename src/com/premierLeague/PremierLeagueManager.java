...
public class PremierLeagueManager implements LeagueManager, Serializable {
    ...
    public boolean addMatch(String id1, String score1, String id2, String score2, Date date){
        ...
        club1.setNumbersOfMatchesPlayed(); //numbers of matches default set to the clubs
        ...
        club1.setNumbersOfGoalsReceived(Integer.parseInt(score2)); //each goal set to the goals of received, and it set to the clubs
    ...
    //searching the match details by played match date and, it converts to below format
